...
return new class extends Migration
{
    ...
    {
        Schema::create('mutasi_pengurangan', function (Blueprint $table) {
            $table->id();
        ...
        DB::statement("Create View mutasi_penambahan as(
            ...
            (bhp_atribut.volume * bhp_atribut.harga) as jumlah pengurangan,
            from bhp_atribut
    ...
    {
        Schema::dropIfExists('mutasi_pengurangan');
    }
};
